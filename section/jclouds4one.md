...
### [Terradue](https://github.com/Terradue) / [jclouds4one](https://github.com/Terradue/jclouds4one)

|    Language   | Created       | Last update | Stars          | Forks          | 
|:-------------:|:-------------:|:-----------:|:--------------:|:--------------:|
| Shell  | 2013-09-26T12:52:26Z  | 2014-09-04T14:24:48Z  | [0](https://github.com/Terradue/jclouds4one/stargazers) | [0](https://github.com/Terradue/jclouds4one/network) |
...
The jclouds4one driver is an OpenNebula add-on that provides a way to access cloud providers implementing the [Apache Jcloudsü¾Ž†„¼ library](<http://jclouds.incubator.apache.org/>). 
...
The Apache Jcloudsü¾Ž†„¼ API open source library is to date providing support for 30 cloud providers & cloud software stacks.
The jclouds4one development is porting the Apache Jcloudsü¾Ž†„¼ API as a driver for OpenNebula. 
