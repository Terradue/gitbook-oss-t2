...
for (i in chapters) {
  ...
  write(kable(chapter.frame[ , which(names(chapter.frame) %in% c("ProjectName", "Description", "ProgrammingLanguage"))], row.names = FALSE, format = "html"), file=chapter.file, append=TRUE)
